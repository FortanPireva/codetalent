...
import { SubmissionStatus, Difficulty, Availability, CandidateStatus, CompanySize, ClientStatus, ClientOnboardingStatus, JobStatus, ExperienceLevel, EmploymentType, WorkArrangement, JobUrgency, ApplicationStatus } from "@prisma/client";
