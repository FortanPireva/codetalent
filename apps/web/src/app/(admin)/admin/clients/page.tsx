...
import {
  ...
  clientStatusColors,
  clientStatusLabels,
  clientOnboardingStatusColors,
  clientOnboardingStatusLabels,
} from "@/lib/utils";
import { ClientStatus, CompanySize } from "@codetalent/db";
                ...
                <TableBody>
                  {clients?.map((client) => (
                    <TableRow key={client.id}>
                      ...
                      <TableCell>
                        {client.user?.clientStatus ? (
                          <Badge className={clientOnboardingStatusColors[client.user.clientStatus]}>
                            {clientOnboardingStatusLabels[client.user.clientStatus]}
                          </Badge>
                        ) : (
                          <span className="text-xs text-muted-foreground">Admin-created</span>
                        )}
                      </TableCell>
